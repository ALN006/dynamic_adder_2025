module hex_decoder(
	...
	always @(*) begin
		case (bin_in)
			// each segment of the 7-segment display is active low (0 turns it on)
			4'h0: hex_out = 7'b1000000; // display 0
			4'h1: hex_out = 7'b1111001; // display 1
			4'h2: hex_out = 7'b0100100; // display 2 etc.
			...
			default: hex_out = 7'b1111111; // default is off
		endcase
	end
endmodule
